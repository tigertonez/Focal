      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative w-full h-screen flex items-center justify-center text-center bg-black">
          ...
          <div className="max-w-3xl px-4 z-10">
            ...
            <div className="mt-16 flex items-center justify-center">
              <Button size="lg" onClick={handlePrimaryCta} className="bg-white text-[#324E98] hover:bg-gray-200 shadow-lg font-bold px-8 py-6 text-lg rounded-full transition-transform duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <section id="features" className="py-20 bg-background">
          ...
          <div className="container mx-auto px-4 mt-20">
            <div className="border-b-[1.5px] border-border/50"></div>
          </div>
        </section>
        
        {/* SECTION 3: PRICING / TIERS */}
        <section id="waitlist" className="bg-muted pt-0 pb-12 md:pb-20">
            <div className="container mx-auto px-4">
