...
1.  **explanation**: Explain Gross, Operating, and Net Profit. For each, use a bullet point to define it, show the user's value (which MUST be bolded), and explain what it means. Use short paragraphs per bullet. Do NOT add a section title.
